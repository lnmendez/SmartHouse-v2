...
public class add_tab4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_tab4);

        crudDispositivo = new CrudDispositivo(this);

        nombre = (EditText) findViewById(R.id.addt4_name);
        descripcion = (EditText) findViewById(R.id.addt4_descrip);

        toolbar = (Toolbar) findViewById(R.id.addt4_bar);
    ...
    public void addDoor(View view) {
        ...
        for (Dispositivos d : crudDispositivo.deviceList(2)) {
            if (nombre.getText().toString().equals(d.getNombre()) && d.getTipo() == 4) {
        ...
        if (i == 0) {
            ...
            Dispositivos d = new Dispositivos(0, name, describ, 0, 4);
