...
public class add_tab6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_tab6);

        crudDispositivo = new CrudDispositivo(this);

        nombre = (EditText) findViewById(R.id.addt6_name);
        descripcion = (EditText) findViewById(R.id.addt6_descrip);

        toolbar = (Toolbar) findViewById(R.id.addt6_bar);
    ...
    public void addCold(View view) {
        ...
        for (Dispositivos d : crudDispositivo.deviceList(2)) {
            if (nombre.getText().toString().equals(d.getNombre()) && d.getTipo() == 6) {
        ...
        if (i == 0) {
            ...
            Dispositivos d = new Dispositivos(0, name, describ, 0, 6);
