...
public class add_tab3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_tab3);

        crudDispositivo = new CrudDispositivo(this);

        nombre = (EditText) findViewById(R.id.addt3_name);
        descripcion = (EditText) findViewById(R.id.addt3_descrip);

        toolbar = (Toolbar) findViewById(R.id.addt3_bar);
    ...
    public void addMove(View view) {
        ...
        for (Dispositivos d : crudDispositivo.deviceList(2)) {
            if (nombre.getText().toString().equals(d.getNombre()) && d.getTipo() == 3) {
        ...
        if (i == 0) {
            ...
            Dispositivos d = new Dispositivos(0, name, describ, 0, 3);
